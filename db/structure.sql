...
--
-- Temporary table structure for view `amount_brought_back_obs`
--
...
/*!50001 CREATE TABLE `amount_brought_back_obs` (
  `person_id` tinyint NOT NULL,
  `encounter_id` tinyint NOT NULL,
  `order_id` tinyint NOT NULL,
  `obs_datetime` tinyint NOT NULL,
  `drug_inventory_id` tinyint NOT NULL,
  `equivalent_daily_dose` tinyint NOT NULL,
...
--
-- Temporary table structure for view `amount_dispensed_obs`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `amount_dispensed_obs` (
  `person_id` tinyint NOT NULL,
  `encounter_id` tinyint NOT NULL,
  `order_id` tinyint NOT NULL,
  `obs_datetime` tinyint NOT NULL,
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `dde_traditional_authority` (
...
CREATE TABLE `dde_village` (
  ...
  KEY `retired_status` (`retired`)
) ENGINE=InnoDB AUTO_INCREMENT=45307 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE TABLE `earliest_start_date` (
  ...
  `age_at_initiation` tinyint NOT NULL,
...
--
-- Temporary table structure for view `patient_service_waiting_time`
--
...
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `patient_service_waiting_time` (
  `patient_id` tinyint NOT NULL,
  `visit_date` tinyint NOT NULL,
  `start_time` tinyint NOT NULL,
  `finish_time` tinyint NOT NULL,
  `service_time` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;
...
/*!50001 DROP TABLE IF EXISTS `amount_brought_back_obs`*/;
/*!50001 DROP VIEW IF EXISTS `amount_brought_back_obs`*/;
...
/*!50001 DROP TABLE IF EXISTS `amount_dispensed_obs`*/;
/*!50001 DROP VIEW IF EXISTS `amount_dispensed_obs`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
/*!50001 DROP TABLE IF EXISTS `patient_service_waiting_time`*/;
/*!50001 DROP VIEW IF EXISTS `patient_service_waiting_time`*/;
/*!50001 SET @saved_cs_client          = @@character_set_client */;
/*!50001 SET @saved_cs_results         = @@character_set_results */;
/*!50001 SET @saved_col_connection     = @@collation_connection */;
...
-- Dump completed on 2014-11-10 14:02:13
